...
class Renderer:
    ...
    def create_shop_panel(self, game) -> Panel:
        ...
        for i, item in enumerate(items):
            num = i + 1
            sel_marker = "▶ " if i == game.shop_sel else "  "
    ...
    def create_gameover_panel(self, game) -> Panel:
        ...
        text.append("\n")
        text.append("按 R 重新开始  按 Q 退出", style="dim")
    ...
    def render_with_upgrade(self, game) -> Layout:
        ...
        upgrade_layout = Layout()
        upgrade_layout.split_column(
            Layout(self.create_upgrade_panel(game), size=10),
            layout,
        )
